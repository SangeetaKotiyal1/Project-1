...
class Developer:
    def __init__(self,root):
        ...
        l1_label=Label(Right_frame,text="Hi guys my name is SANGEETA KOTIYAL, currently pursuing B.Tech in Computer Science from Graphic", font=("Bahnschrift Condensed",20,"bold"),bg="white", fg="black")
